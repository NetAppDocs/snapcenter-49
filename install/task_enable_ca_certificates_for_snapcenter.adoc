...
The information regarding the parameters that can be used with the cmdlet and their descriptions can be obtained by running _Get-Help command_name_. Alternatively, you can refer to the https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.htmlllll[SnapCenter Software Cmdlet Reference Guide^].

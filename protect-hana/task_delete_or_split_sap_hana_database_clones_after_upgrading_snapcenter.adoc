...
. Select the clones, and then click image:../media/delete_icon.gif[delete clone] to delete clones or click image:../media/split_cone.gif[split clone] to split the clones.
. Click *OK*.

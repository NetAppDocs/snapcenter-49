...
+
For more information on Windows cmdlets see https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.htmlllllll[SnapCenter Software Cmdlet Reference Guide^].
+
...
image::../media/snapcenter_architecture.gif[architecture of SnapCenter]
